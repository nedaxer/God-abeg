          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div className="bg-[#f5f5f5] p-6 rounded-lg">
              ...
              <ul className="space-y-2">
                ...
                <li className="flex items-start">
                  <Check className="text-[#ff5900] mt-1 mr-2 h-5 w-5 flex-shrink-0" />
                  <span className="text-gray-900">Trade with leverage for enhanced returns</span>
                </li>
                <li className="flex items-start">
                  <Check className="text-[#ff5900] mt-1 mr-2 h-5 w-5 flex-shrink-0" />
                  <span className="text-gray-900">No need for manual stop-loss orders</span>
                </li>
                <li className="flex items-start">
                  <Check className="text-[#ff5900] mt-1 mr-2 h-5 w-5 flex-shrink-0" />
                  <span className="text-gray-900">Know your exact risk and potential reward upfront</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-[#f5f5f5] p-6 rounded-lg">
              ...
              <ul className="space-y-2">
                <li className="flex items-start">
                  <Check className="text-[#ff5900] mt-1 mr-2 h-5 w-5 flex-shrink-0" />
                  <span className="text-gray-900">Select a market and Touch Bracket contract</span>
                </li>
                <li className="flex items-start">
                  <Check className="text-[#ff5900] mt-1 mr-2 h-5 w-5 flex-shrink-0" />
        ...
        <div className="mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
              ...
              <p className="mb-4 text-gray-900">Trade Touch Brackets on Bitcoin with defined risk levels for volatile markets.</p>
              <Button 
                asChild
                variant="outline" 
            ...
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
              ...
              <p className="mb-4 text-gray-900">Trade Touch Brackets on Ethereum with built-in price brackets to limit risk.</p>
              <Button 
                asChild
                variant="outline" 
                className="w-full border-[#0033a0] text-[#0033a0] hover:bg-[#0033a0] hover:text-white"
            ...
            <div className="border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
              ...
              <p className="mb-4 text-gray-900">Trade Touch Brackets on leading altcoins with automatic knockout levels.</p>
              <Button 
                asChild
                variant="outline" 
                className="w-full border-[#0033a0] text-[#0033a0] hover:bg-[#0033a0] hover:text-white"

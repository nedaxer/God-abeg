      ...
      <div className="max-w-3xl mx-auto bg-white p-8 rounded-xl shadow-lg border border-blue-50">
        ...
        <div className="text-center mb-6">
          ...
          <a 
            ...
            className="inline-flex items-center justify-center py-2.5 px-6 border border-gray-300 rounded-md shadow-sm bg-white hover:bg-gray-50 text-sm font-medium text-gray-700 transition-colors disabled:opacity-50"
          >
            {googleLoading ? (
              <>
